...
public class PolyNav2DInspector : Editor {
	...
	public override void OnInspectorGUI(){
		...
		polyNav.generateOnUpdate = EditorGUILayout.Toggle("Generate On Update", polyNav.generateOnUpdate);
		polyNav.obstaclesLayer = EditorGUILayout.LayerField("Obstacles Layer", polyNav.obstaclesLayer);
