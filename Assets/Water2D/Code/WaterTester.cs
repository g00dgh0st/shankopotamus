	...
	void Update () {
		...
		if (Input.GetMouseButtonDown(0))
		{
			...
			if (objectToInstantiate != null)
			{
				...
				if (instatiatedObject.GetComponent<Rigidbody>() != null)
					instatiatedObject.GetComponent<Rigidbody>().mass = Mathf.Lerp(0.1f,1f,Mathf.InverseLerp(0.5f,1.3f, instatiatedObject.transform.localScale.x));
				else
					instatiatedObject.GetComponent<Rigidbody2D>().mass = Mathf.Lerp(0.1f,1f,Mathf.InverseLerp(0.5f,1.3f, instatiatedObject.transform.localScale.x));
			}
			else
			{
